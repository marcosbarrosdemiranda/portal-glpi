    ...
    itens.forEach(m => {
      ...
      html += `<div class="maq-card" id="maq-${m.id}">
        ...
        <div class="maq-actions">
          <a class="btn-rdp btn-nativo" href="rdp_launch.php?id=${m.id}" title="Abre a Área de Trabalho Remota do seu PC"><i class="bi bi-pc-display-horizontal"></i>Abrir Área de Trabalho</a>
